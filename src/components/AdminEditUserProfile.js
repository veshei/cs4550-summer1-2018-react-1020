...
/**
 * Component that allows admins to edit other users' profiles.
 */
export default class AdminEditUserProfile extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            user: {
    ...
    saveProfile() {
        ...
        if(this.state.firstName.length <= 0){
            ...
            this.userService.updateUserById(this.state.user.id, updatedUser).then(updatedUser => {
                if (updatedUser) {
